...
This guide explains how to preprocess raw EEG data from the new folder structure.
...
You can modify the following parameters in `preprocess_raw_eeg.py`:
